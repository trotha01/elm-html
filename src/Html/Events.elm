module Html.Events (onBlur, onFocus, onSubmit, onKeyUp, onKeyDown, onKeyPress, onClick, onDoubleClick, onMouseMove, onMouseDown, onMouseUp, onMouseEnter, onMouseLeave, onMouseOver, onMouseOut, on, onWithOptions, Options, defaultOptions, targetValue, targetChecked, keyCode) where
