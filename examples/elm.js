...
Elm.Html.make = function (_elm) {
   ...
   var render = function (html) {
      ...
      if (_p0.ctor === "Node") {
            ...
            _p0._0,
            _p0._1,
            A2($List.map,render,_p0._2));
         } else {
            return $VirtualDom.text(_p0._0);
         }
   };
   var toElement = F3(function (x,y,html) {
      return A3($VirtualDom.toElement,x,y,render(html));
   });
   ...
   var node = Node;
   var body = A3(node,"body",_U.list([]),_U.list([]));
   var section = A3(node,"section",_U.list([]),_U.list([]));
   var nav = A3(node,"nav",_U.list([]),_U.list([]));
   var article = A3(node,"article",_U.list([]),_U.list([]));
   var aside = A3(node,"aside",_U.list([]),_U.list([]));
   var h1 = A3(node,"h1",_U.list([]),_U.list([]));
   var h2 = A3(node,"h2",_U.list([]),_U.list([]));
   var h3 = A3(node,"h3",_U.list([]),_U.list([]));
   var h4 = A3(node,"h4",_U.list([]),_U.list([]));
   var h5 = A3(node,"h5",_U.list([]),_U.list([]));
   var h6 = A3(node,"h6",_U.list([]),_U.list([]));
   var header = A3(node,"header",_U.list([]),_U.list([]));
   var footer = A3(node,"footer",_U.list([]),_U.list([]));
   var address = A3(node,"address",_U.list([]),_U.list([]));
   var main$ = A3(node,"main",_U.list([]),_U.list([]));
   var p = A3(node,"p",_U.list([]),_U.list([]));
   var hr = A3(node,"hr",_U.list([]),_U.list([]));
   var pre = A3(node,"pre",_U.list([]),_U.list([]));
   var blockquote = A3(node,"blockquote",_U.list([]),_U.list([]));
   var ol = A3(node,"ol",_U.list([]),_U.list([]));
   var ul = A3(node,"ul",_U.list([]),_U.list([]));
   var li = A3(node,"li",_U.list([]),_U.list([]));
   var dl = A3(node,"dl",_U.list([]),_U.list([]));
   var dt = A3(node,"dt",_U.list([]),_U.list([]));
   var dd = A3(node,"dd",_U.list([]),_U.list([]));
   var figure = A3(node,"figure",_U.list([]),_U.list([]));
   var figcaption = A3(node,"figcaption",_U.list([]),_U.list([]));
   var div = A3(node,"div",_U.list([]),_U.list([]));
   var a = A3(node,"a",_U.list([]),_U.list([]));
   var em = A3(node,"em",_U.list([]),_U.list([]));
   var strong = A3(node,"strong",_U.list([]),_U.list([]));
   var small = A3(node,"small",_U.list([]),_U.list([]));
   var s = A3(node,"s",_U.list([]),_U.list([]));
   var cite = A3(node,"cite",_U.list([]),_U.list([]));
   var q = A3(node,"q",_U.list([]),_U.list([]));
   var dfn = A3(node,"dfn",_U.list([]),_U.list([]));
   var abbr = A3(node,"abbr",_U.list([]),_U.list([]));
   var time = A3(node,"time",_U.list([]),_U.list([]));
   var code = A3(node,"code",_U.list([]),_U.list([]));
   var $var = A3(node,"var",_U.list([]),_U.list([]));
   var samp = A3(node,"samp",_U.list([]),_U.list([]));
   var kbd = A3(node,"kbd",_U.list([]),_U.list([]));
   var sub = A3(node,"sub",_U.list([]),_U.list([]));
   var sup = A3(node,"sup",_U.list([]),_U.list([]));
   var i = A3(node,"i",_U.list([]),_U.list([]));
   var b = A3(node,"b",_U.list([]),_U.list([]));
   var u = A3(node,"u",_U.list([]),_U.list([]));
   var mark = A3(node,"mark",_U.list([]),_U.list([]));
   var ruby = A3(node,"ruby",_U.list([]),_U.list([]));
   var rt = A3(node,"rt",_U.list([]),_U.list([]));
   var rp = A3(node,"rp",_U.list([]),_U.list([]));
   var bdi = A3(node,"bdi",_U.list([]),_U.list([]));
   var bdo = A3(node,"bdo",_U.list([]),_U.list([]));
   var span = A3(node,"span",_U.list([]),_U.list([]));
   var br = A3(node,"br",_U.list([]),_U.list([]));
   var wbr = A3(node,"wbr",_U.list([]),_U.list([]));
   var ins = A3(node,"ins",_U.list([]),_U.list([]));
   var del = A3(node,"del",_U.list([]),_U.list([]));
   var img = A3(node,"img",_U.list([]),_U.list([]));
   var iframe = A3(node,"iframe",_U.list([]),_U.list([]));
   var embed = A3(node,"embed",_U.list([]),_U.list([]));
   var object = A3(node,"object",_U.list([]),_U.list([]));
   var param = A3(node,"param",_U.list([]),_U.list([]));
   var video = A3(node,"video",_U.list([]),_U.list([]));
   var audio = A3(node,"audio",_U.list([]),_U.list([]));
   var source = A3(node,"source",_U.list([]),_U.list([]));
   var track = A3(node,"track",_U.list([]),_U.list([]));
   var canvas = A3(node,"canvas",_U.list([]),_U.list([]));
   var svg = A3(node,"svg",_U.list([]),_U.list([]));
   var math = A3(node,"math",_U.list([]),_U.list([]));
   var table = A3(node,"table",_U.list([]),_U.list([]));
   var caption = A3(node,"caption",_U.list([]),_U.list([]));
   var colgroup = A3(node,"colgroup",_U.list([]),_U.list([]));
   var col = A3(node,"col",_U.list([]),_U.list([]));
   var tbody = A3(node,"tbody",_U.list([]),_U.list([]));
   var thead = A3(node,"thead",_U.list([]),_U.list([]));
   var tfoot = A3(node,"tfoot",_U.list([]),_U.list([]));
   var tr = A3(node,"tr",_U.list([]),_U.list([]));
   var td = A3(node,"td",_U.list([]),_U.list([]));
   var th = A3(node,"th",_U.list([]),_U.list([]));
   var form = A3(node,"form",_U.list([]),_U.list([]));
   var fieldset = A3(node,"fieldset",_U.list([]),_U.list([]));
   var legend = A3(node,"legend",_U.list([]),_U.list([]));
   var label = A3(node,"label",_U.list([]),_U.list([]));
   var input = A3(node,"input",_U.list([]),_U.list([]));
   var button = A3(node,"button",_U.list([]),_U.list([]));
   var select = A3(node,"select",_U.list([]),_U.list([]));
   var datalist = A3(node,"datalist",_U.list([]),_U.list([]));
   var optgroup = A3(node,"optgroup",_U.list([]),_U.list([]));
   var option = A3(node,"option",_U.list([]),_U.list([]));
   var textarea = A3(node,"textarea",_U.list([]),_U.list([]));
   var keygen = A3(node,"keygen",_U.list([]),_U.list([]));
   var output = A3(node,"output",_U.list([]),_U.list([]));
   var progress = A3(node,"progress",_U.list([]),_U.list([]));
   var meter = A3(node,"meter",_U.list([]),_U.list([]));
   var details = A3(node,"details",_U.list([]),_U.list([]));
   var summary = A3(node,"summary",_U.list([]),_U.list([]));
   var menuitem = A3(node,"menuitem",_U.list([]),_U.list([]));
   var menu = A3(node,"menu",_U.list([]),_U.list([]));
   var addAttribute = F2(function (attr,node) {
      var _p1 = node;
      if (_p1.ctor === "Node") {
            return A3(Node,
            _p1._0,
            A2($List._op["::"],attr,_p1._1),
            _p1._2);
         } else {
            return Text(_p1._0);
         }
   });
   var addChild = F2(function (child,parent) {
      var _p2 = parent;
      if (_p2.ctor === "Node") {
            return A3(Node,
            _p2._0,
            _p2._1,
            A2($List.append,_p2._2,_U.list([child])));
         } else {
            return Text(_p2._0);
         }
   });
   var addChildren = F2(function (newChildren,parent) {
      var _p3 = parent;
      if (_p3.ctor === "Node") {
            return A3(Node,
            _p3._0,
            _p3._1,
            A2($List.append,_p3._2,newChildren));
         } else {
            return Text(_p3._0);
         }
   });
...
Elm.Html.Events.make = function (_elm) {
   ...
   var onSubmitOptions = _U.update(defaultOptions,
   {preventDefault: true});
   var Options = F2(function (a,b) {
      return {stopPropagation: a,preventDefault: b};
   });
   var onWithOptions = $VirtualDom.onWithOptions;
   var onSubmit = F2(function (addr,msg) {
      return A4(onWithOptions,
      "submit",
      onSubmitOptions,
      $Json$Decode.value,
      function (_p0) {
...
Elm.Main.make = function (_elm) {
   ...
   var field = F5(function (fieldType,
   address,
   toAction,
   name,
   content) {
      return A2($Html.addChild,
      A2($Html.addAttribute,
      A3($Html$Events.on,
      "input",
      ...
      A2($Html.addChild,
      $Html.text(name),
      A2($Html.addAttribute,fieldNameStyle("160px"),$Html.div)),
      $Html.div));
   });
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "Name": return _U.update(model,{name: _p0._0});
         case "Password": return _U.update(model,{password: _p0._0});
         default: return _U.update(model,{passwordAgain: _p0._0});}
   });
   var PasswordAgain = function (a) {
   ...
   var view = F2(function (address,model) {
      return $Html.render(function () {
         var validationMessage = _U.eq(model.password,
         model.passwordAgain) ? A2($Html.addChild,
         $Html.text("Passwords Match!"),
         A2($Html.addAttribute,
         $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                         ,_0: "color"
                                         ,_1: "green"}])),
         $Html.span)) : A2($Html.addChild,
         $Html.text("Passwords do not match :("),
         A2($Html.addAttribute,
         $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                         ,_0: "color"
                                         ,_1: "red"}])),
         ...
         A2($Html.addChild,
         validationMessage,
         A2($Html.addAttribute,fieldNameStyle("300px"),$Html.div)),
         A2($Html.addChild,
         A5(field,
         "password",
         address,
         ...
         A2($Html.addChild,
         A5(field,"text",address,Name,"User Name",model.name),
         $Html.div))));
      }());
   });
